...
[x,a,b,c,d] = lsqcurvefit(@logistic, [150 1e-2], [Data1(:,1);Data2(:,1);Data3(:,1)], [Data1(:,2);Data2(:,2);Data3(:,2)]);

hold on
L=linspace(1790,2050);
plot(L,logistic(x,L))
...
export_fig('../Pictures/US_logistic_population_2030.png','-r300')
